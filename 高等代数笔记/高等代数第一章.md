...
>**定义**  
向量方程  
$$0=x_1c_1+\cdots+x_ic_i$$
>仅有平凡解(trivial solution)  
向量组 (集) 称为线性无关的 (linearly independent)
...
>**定理10**  
设 T : R<sup>n</sup> → R<sup>m</sup> 为线性变换,则存在唯一的矩阵 A ,使得对 R<sup>n</sup>中一切 x 满足
...
>**定理11**  
设 T : R<sup>n</sup> → R<sup>m</sup> 为线性变换,则 T 是一对一的当且仅当方程 Ax=O 仅有平凡解.
